...
class TestUtils(unittest.TestCase):
    ...
    def test_get_parsing(self):
        crt = Crtsh()
        cert = crt.get("253073880", ctype="id")
    ...
    def test_get_unknown_id(self):
        crt = Crtsh()
        try:
            _ = crt.get("81863923950", ctype="id")
    ...
    def test_get_sha1(self):
        crt = Crtsh()
        cert = crt.get("B387B1F38800844F5E8FBA0F4442BFB3892BE2A9", ctype="sha1")
        self.assertEqual(cert["id"], "8186392")
        self.assertEqual(cert["sha1"], "B387B1F38800844F5E8FBA0F4442BFB3892BE2A9")
        self.assertEqual(
            cert["sha256"],
